...
TOOL NAME
- get the jira - "JIRA".tool
- get the prd - "READ_PRD".tool

1. Retrieve and analyze the **Product Requirement Document (PRD)** from the attached document tool "READ_PDR".tool.
2. Retrieve and analyze the **Jira ticket** using the provided Jira ID "JIRA".tool.
